...
class GQA_gt_sg_feature_lookup:
    ...
    SG_ENCODING_TEXT = torchtext.data.Field(sequential=True, tokenize="spacy",
                                            ...
                                            batch_first=False)
    # SG_ENCODING_TEXT = TextProcessor(
    #     init_token="<start>",
    #     eos_token="<end>"
    # )

    def __init__(self, split, graph_method="static"):
        self.split = split
    ...
    def build_scene_graph_encoding_vocab(self):
        ...
        # GQA_gt_sg_feature_lookup.SG_ENCODING_TEXT.build_vocab(tmp_text_list)
    ...
    def convert_one_gqa_scene_graph(self, sg_this, graph_method=None):

        if graph_method is None:
            graph_method = getattr(self, "graph_method", "static")
        ...
        datum.graph_method = graph_method
...
class GQATorchDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.sg_feature_lookup = GQA_gt_sg_feature_lookup(self.split, graph_method=graph_method) # Using Ground Truth
