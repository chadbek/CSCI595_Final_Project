...
def get_args_parser():
    ...
    parser.add_argument("--graph_method", default="static", 
                        choices=["static", "fully_connected", "reweight", "augment", "prune"])
    parser.add_argument("--graph-top-k", default=5, type=int)
    parser.add_argument("--graph-hidden-dim", default=256, type=int, 
                        help="hidden dimension of graph-construction MLPs")
